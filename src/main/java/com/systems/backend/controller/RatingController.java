...
public class RatingController {
    ...
    public ResponseEntity<List<RatingResponse>> getRatingByAccountId(@PathVariable Long accountId) {
        try {
            List<RatingResponse> rating = ratingService.getRatingByAccountId(accountId);
